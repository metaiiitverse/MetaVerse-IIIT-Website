  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="flex flex-col text-center w-full mb-20">
        ...
        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Just place holder text which we will replace with other tex  when we will get</p>
      </div>
      <div className="flex flex-wrap -m-4">
        <div className="p-4 lg:w-1/4 md:w-1/2">
          <div className="h-full flex flex-col items-center text-center">
            ...
            <div className="w-full">
              <h2 className="title-font font-medium text-lg text-white">Random name</h2>
              <h3 className="text-gray-500 mb-3"> Developer</h3>
              <p className="mb-4">Just place holder text which we will replace with other tex  when we will get.</p>
        ...
        <div className="p-4 lg:w-1/4 md:w-1/2">
          <div className="h-full flex flex-col items-center text-center">
            ...
            <div className="w-full">
              <h2 className="title-font font-medium text-lg text-white">Random Nmae</h2>
              <h3 className="text-gray-500 mb-3">Developer</h3>
              <p className="mb-4">Just place holder text which we will replace with other tex  when we will get</p>
              <span className="inline-flex">
                <a className="text-gray-700">
